...
public class Kayttoliittyma {
    ...
    public void tulostaKeskiarvot() {
        System.out.println("Koepisteiden keskiarvo: ");
        System.out.println(this.rekisteri.koepisteidenKeskiarvo());
        System.out.println("Arvosanojen keskiarvo: ");
        System.out.println(this.rekisteri.arvosanojenKeskiarvo());
    }
}
